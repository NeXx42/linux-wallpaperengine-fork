...
class ObjectParser {
  ...
  private:
    ...
    static ImageUniquePtr parseImage (const JSON& it, const Project& project, ObjectData base,
    ...
    static std::vector<ImageEffectPassOverrideUniquePtr> parseEffectPassOverrides (const JSON& it,
